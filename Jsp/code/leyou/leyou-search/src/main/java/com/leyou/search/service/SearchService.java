...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        Map<String,List<Object>> specialSpecMap = MAPPER.readValue(spuDetail.getSpecialSpec(),
                new TypeReference<Map<String,List<Object>>>(){});//<Map<String,List<Object>>>
    ...
    public SearchResult search(SearchRequest request) {
        ...
        //添加结果集过滤
        queryBuilder.withSourceFilter(new FetchSourceFilter(new
                String[]{"id","skus","subTitle"},null));
